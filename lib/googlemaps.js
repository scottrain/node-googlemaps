...
exports.places = function(request) {
  var args = {
  ...
  if (request.urlOnly) {
    ...
    return makeRequest(path, args, true, returnObjectFromJSON(request.callback));
  }
};

exports.placeDetails = function(request) {
  var args = {
...
exports.geocode = function(request) {
  var args = {
  ...
  if (request.urlOnly) {
    ...
    return makeRequest(path, args, false, returnObjectFromJSON(request.callback));
  }
};

// http://code.google.com/apis/maps/documentation/geocoding/#ReverseGeocoding
exports.reverseGeocode = function(request) {
  var args = {
...
exports.distance = function(request) {
  var args = {
...
exports.directions = function(request) {
  var args = {
...
exports.elevationFromLocations = function(request) {
...
exports.elevationFromPath = function(request) {
  if (config('encode-polylines')){
  ...
  if (count === 1) {
    if (request.urlOnly) {
      ...
      makeRequest(reqPath, args, false, returnObjectFromJSON(request.callback));
    }
  } else {
...
exports.staticMap = function(request) {
  var args = {
  ...
  if (request.urlOnly) {
    ...
    return makeRequest(path, args, false, request.callback, 'binary');
  }
};

// http://code.google.com/apis/maps/documentation/streetview
exports.streetView = function(request) {
  var args = {
    'size': request.size,
